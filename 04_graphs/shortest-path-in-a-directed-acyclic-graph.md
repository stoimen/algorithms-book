...
[![Negative Cycles](../images/1.-Negative-Cycles.png)](../images/1.-Negative-Cycles.png)The presence of a negative cycles make our atempt to find the shortest path pointless!
...
[![Topological Sort](../images/2.-Topological-Sort.png)](../images/2.-Topological-Sort.png)Topological sort is often used to “sort” dependent tasks!
...
[![Topological Sort (part 2)](../images/3.-Topological-Sort-part-2.png)](../images/3.-Topological-Sort-part-2.png)If there’s an edge (u,v) then u must precede v. This results in the more general case from the image. There’s no edge between B and D, but B precedes D!
