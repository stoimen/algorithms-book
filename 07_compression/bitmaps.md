...
[![Bitmap Compression](../images/Run-lengthvs.BitmapCompression.png)](../images/Run-lengthvs.BitmapCompression.png)Basically bitmap compression saves the positions of an element that is repeated very often in the message!
